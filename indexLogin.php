      ...
      <div class="u-align-center u-container-style u-group u-white u-group-1">
        <div class="u-container-layout u-container-layout-1">
          ...
          <h5 class="u-custom-font u-font-lato u-text u-text-default u-text-2">
            <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-hover-custom-color-5 u-text-palette-1-light-1 u-btn-1" href="Cadastre-se.html">Ainda não é cadastrado? Acesse Aqui!</a>
          </h5>
          <?php
          ...
          <div class="u-expanded-width u-form u-form-1">
            <form action="login.php" method="POST" class="u-clearfix u-form-spacing-16 u-inner-form " style="padding: 9px;" source="custom" name="form">
              ...
              <div class="u-form-group u-form-group-2">
                ...
                <input type="password" placeholder="Senha" id="text-8b24" name="senha" class="u-grey-10 u-input u-input-rectangle u-input-2">
              </div>
          ...
          <p class="u-text u-text-3">
            <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-btn-3" href="indexLogin.php#sec-ebba" data-page-id="541209197">Esqueci a senha</a>
          </p>
        </div>
      </div>
    </div>
