<div class="u-align-left u-border-1 u-border-grey-25 u-container-style u-custom-color-1 u-custom-item u-list-item u-radius-9 u-repeater-item u-shape-round u-list-item-1 fadeImg2" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">
        ...
        <table class="u-table-entity">
          ...
          <tbody class="u-table-body u-table-body-1">
            <tr style="height: 26px;">
              ...
              <td class="u-table-cell"><?php echo $_SESSION['nome'], ' ', $_SESSION['sobrenome'];?></td>
            </tr>
            <tr style="height: 26px;">
              <td class="u-first-column u-table-cell u-table-cell-3">Email:</td>
              <td class="u-table-cell"><?php echo $_SESSION['email'];?></td>
            </tr>
            <tr style="height: 26px;">
              <td class="u-border-2 u-border-grey-10 u-border-no-left u-border-no-right u-first-column u-table-cell u-table-cell-5"><a href="http://">Editar Dados</a></td>
              <td class="u-align-right u-border-2 u-border-grey-10 u-border-no-left u-border-no-right u-table-cell u-table-cell-6"><a href="logout.php"><b>SAIR</b></a></td>
            </tr>
          </tbody>
        </table>
      </div>
